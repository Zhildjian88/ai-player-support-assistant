...
def process_message(
    ...
    if _msg_stripped in _ACTION_MAP:
        ...
        if _msg_stripped == "action:rg":
            ...
            acct     = _acc.get(user_id) if user_id else {}
            ...
            pay      = _pay.get(user_id) if user_id else {}
            ...
            promo    = _pro.get(user_id) if user_id else {}
            ...
            rules    = _gm.get(message) if hasattr(_gm, "get") else {}
