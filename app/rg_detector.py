...
LOSS_OF_CONTROL = [
    ...
    # Formal/clinical phrasing — DSM-5 style (English)
    "unable to cease wagering", "unable to cease gambling",
    "unable to stop wagering", "repeated attempts to stop",
    "repeated unsuccessful attempts", "persistent attempts to reduce",
    "cannot control my wagering", "cannot control wagering",
    "compulsion to wager", "compulsion to gamble",
    "uncontrollable urge to bet", "uncontrollable urge to gamble",
    "despite attempts to stop", "despite repeated attempts",
    "find myself gambling", "find myself wagering",
    "involuntary gambling", "unable to refrain from gambling",
    "unable to refrain from wagering",
    # Formal/clinical — Thai
    "ไม่สามารถหยุดการพนันได้", "พยายามหยุดแต่ทำไม่ได้",
    "ไม่สามารถควบคุมการพนันได้", "มีแรงกระตุ้นที่ไม่สามารถต้านทานได้",
    "พยายามลดการพนันแต่ไม่สำเร็จ", "ไม่สามารถงดการพนันได้",
    # Formal/clinical — Indonesian/Malay
    "tidak mampu berhenti berjudi", "telah mencoba berhenti namun gagal",
    "tidak dapat mengendalikan perjudian", "dorongan yang tidak terkendali untuk berjudi",
    "upaya berulang untuk berhenti", "tidak mampu menahan diri dari berjudi",
    "tidak dapat mengontrol kebiasaan berjudi", "gagal menghentikan perjudian",
    # Formal/clinical — Vietnamese
    "không thể ngừng đánh bạc dù đã cố gắng", "nhiều lần cố gắng nhưng không thể dừng",
    "không kiểm soát được hành vi cờ bạc", "thôi thúc không thể cưỡng lại khi cờ bạc",
    "cố gắng giảm cờ bạc nhưng thất bại", "không thể tự kiềm chế việc đánh bạc",
    # Formal/clinical — Filipino/Tagalog
    "hindi makatigil sa pagsusugal kahit nagtatangka", "paulit-ulit na sinubukan pero hindi makatigil",
    "hindi makontrol ang pagsusugal", "hindi mapigilan ang sarili sa pagsusugal",
    "maraming pagkakataon na sinubukang tigilan ang sugal",
    "walang kakayahang pigilan ang pagnanasa sa pagsusugal",
    # Formal/clinical — Chinese
    "尽管多次尝试仍无法停止赌博", "无法控制赌博行为",
    "多次尝试戒赌但未能成功", "对赌博有无法抗拒的冲动",
    "持续尝试减少赌博但失败", "无法自制地参与赌博活动",
    "屡次努力戒赌均告失败", "unable to cease gambling",
    "unable to stop wagering", "repeated attempts to stop",
    "repeated unsuccessful attempts", "persistent attempts to reduce",
    "cannot control my wagering", "cannot control wagering",
    "compulsion to wager", "compulsion to gamble",
